...
const styles = {
    container: { padding: '140px 5%', background: '#f8faff', minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' },
    card: { background: 'white', padding: '45px', borderRadius: '24px', boxShadow: '0 20px 40px rgba(0,0,0,0.05)', width: '100%', maxWidth: '550px', textAlign: 'center' },
    headerIcon: { marginBottom: '20px', display: 'inline-block', padding: '15px', background: '#f0f7ff', borderRadius: '15px' },
    title: { color: '#0056b3', fontSize: '26px', fontWeight: '900', marginBottom: '10px' },
    subtitle: { color: '#666', lineHeight: '1.5', fontSize: '15px' },
    form: { display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '30px' },
    input: { width: '100%', padding: '15px', borderRadius: '12px', border: '1px solid #ddd', outline: 'none', fontSize: '15px', boxSizing: 'border-box' },
    textarea: { width: '100%', padding: '15px', borderRadius: '12px', border: '1px solid #ddd', height: '130px', outline: 'none', fontSize: '15px', resize: 'none', boxSizing: 'border-box' },
    btn: { padding: '16px', background: '#0056b3', color: 'white', border: 'none', borderRadius: '12px', fontWeight: 'bold', cursor: 'pointer', fontSize: '16px' },
